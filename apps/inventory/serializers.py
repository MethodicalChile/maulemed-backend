...
class InventoryMovementSerializer(serializers.ModelSerializer):
    warehouse_origin_detail = WarehouseSmallSerializer(
        source="warehouse_origin",
        read_only=True,
    )
    warehouse_destination_detail = WarehouseSmallSerializer(
        source="warehouse_destination",
        read_only=True,
    )
    product_detail = ProductSmallSerializer(
        source="product",
